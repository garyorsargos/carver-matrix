...
import com.fmc.carverApp.configuration.security.CustomAccessDeniedHandler;
import com.fmc.carverApp.configuration.security.JwtAuthConverter;
import com.fmc.carverApp.configuration.security.JwtAuthenticationEntryPoint;
...
public class SecurityConfiguration {
    ...
    public static final String CARVER_ADMIN = "CARVER_ADMIN";
    public static final String CARVER_READ = "CARVER_READ";
    public static final String CARVER_WRITE = "CARVER_WRITE";
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers("/api/admin/**").hasRole(CARVER_ADMIN)
